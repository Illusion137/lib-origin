...
export interface FileSystem {
    ...
    write_file_as_string: (path: string, contents: string, opts: EncodingOpts) => Promise<undefined|ResponseError>;
    ...
    download_to_file: (uri: string, to_path?: string) => Promise<string>
}