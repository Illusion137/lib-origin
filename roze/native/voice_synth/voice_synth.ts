...
switch (get_native_platform()) {
	...
	case "ELECTRON_RENDERER":
		console.error("Electron Renderer Native VoiceSynth is NOT implemented");
		break;
	case "NODE":
		try {
			voice_synth = require("./voice_synth.node").node_voice_synth;
		} catch (e) {}
		break;
	case "REACT_NATIVE":
		try {
			voice_synth = require("./voice_synth.mobile").mobile_voice_synth;
		} catch (e) {}
		break;
}
