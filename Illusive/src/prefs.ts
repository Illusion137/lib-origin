...
export namespace Prefs {
    ...
    export const prefs = {
        ...
        tracks_per_sample:                     {default_value: 3, current_value: 3, type: "NUMBER", range: {start: 1, end: 10}, show_in_settings: true, section: "Automation", description: "The number of tracks to sample when Illusi automatically checks for unavailable songs, even if downloaded. This check could happen randomly every song; If expensive_wifi_only then this action only occurs when on wifi"}  as Pref<number>,
        edit_mode_disables_playing:            {default_value: true, current_value: true, type: "BOOLEAN", show_in_settings: true, description: "If-Enabled; When you are in an edit-mode you can't click on a track", section: "Interactions"} as Pref<boolean>,
        use_cookies_on_download:               {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, section: "Data"}  as Pref<boolean>,
        use_cookies_on_search:                 {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, section: "Data"}  as Pref<boolean>,
        use_cookies_on_artist:                 {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, section: "Data"}  as Pref<boolean>,
        media_files_on_albums:                 {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, description: "If-Enabled; When you search or open an album, any tracks in your library will show their downloaded version; May negatively affect performance", section: "Visual"} as Pref<boolean>,
        compact_playlists:                     {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, description: "If-Enabled; Your playlists in the 'Playlist' screen will become smaller", section: "Visual"} as Pref<boolean>,
        hide_batch_undownloader:               {default_value: true, current_value: true, type: "BOOLEAN", show_in_settings: true, section: "Visual", description: "If-Enabled; won't show Batch Un-Downloader in extras page (Modification may require restart)"}  as Pref<boolean>,
        hide_errors:                           {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, section: "Visual"}  as Pref<boolean>,
        ...
        play_without_popup:                    {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, description: "If-Enabled; When clicking on a track if you already are playing music, the player won't popup", section: "Audioplayer"} as Pref<boolean>,
