...
export namespace Prefs {
    ...
    export const cozy_dark_theme: Theme = {
        dark: true,
        colors: {
            default_primary_color: '#c97b5a',
            primary: get_pref('primary_color'),
            secondary: '#c46a8f',
            background: '#1a1410',
            primary_dark: '#2a1e14',
    ...
    export const deep_ocean_theme: Theme = {
        dark: true,
        colors: {
            default_primary_color: '#00b8a0',
            primary: get_pref('primary_color'),
            secondary: '#e08840',
            background: '#080e12',
            primary_dark: '#0e2030',
