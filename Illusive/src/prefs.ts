...
export namespace Prefs {
    ...
    export const prefs = {
        ...
        edit_mode_disables_playing:            {default_value: true, current_value: true, type: "BOOLEAN", show_in_settings: true, show_in_type: "MISC", description: "If-Enabled; When you are in an edit-mode you can't click on a track"} as Pref<boolean>,
        full_queue_disables_playing:           {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "MISC", description: "If-Enabled; If your pushed-queue isn't empty then you can't click on a track"} as Pref<boolean>,
