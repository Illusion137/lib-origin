...
export namespace Prefs {
    ...
    export const prefs = {
        ...
        tracks_per_sample:                     {default_value: 10, current_value: 10, type: "NUMBER", range: {start: 1, end: 10}, show_in_settings: true, show_in_type: "MISC", section: "Automation"}  as Pref<number>,
        ...
        safe_mode:                             {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Interactions"}  as Pref<boolean>,
        safe_mode_undownload:                  {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Interactions"}  as Pref<boolean>,
        can_redownload:                        {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Interactions"}  as Pref<boolean>,
        can_redownload_batch:                  {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Interactions"}  as Pref<boolean>,
        force_redownload_conversion:           {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Data"}  as Pref<boolean>,
        ...
        force_explicit_conversion:             {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Automation"}  as Pref<boolean>,
        ...
        auto_clean_directories:                {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Automation"}  as Pref<boolean>,
        can_clean_directories:                 {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Automation"}  as Pref<boolean>,
        track_player_file_searching:           {default_value: false, current_value: false, type: "BOOLEAN", show_in_settings: true, show_in_type: "EXPERIMENTAL", section: "Automation"}  as Pref<boolean>,
