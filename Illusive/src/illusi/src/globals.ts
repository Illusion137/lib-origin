...
export const global_var = {
    ...
    download_track: async(track: Track, redownload: boolean = false, progress_updater?: SetState, start_download?: SetState, set_finished_downloaded?: SetState): Promise<DownloadTrackResult|void> => {track;redownload;progress_updater;start_download;set_finished_downloaded;},
