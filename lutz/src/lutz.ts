...
import { MangaList } from '../../origin/src/manga_reader/types/types';
...
export namespace Lutz {
    ...
    export async function search_manga_query(query: string, page: number = 0, set_search_manga: SetState = () => {}, set_search_manga_title: SetState = () => {}){
