...
const extractDecipherFunc = (body: string, name: string, code: string) => {
	name;
	try {
...
const extractNTransformFunc = (body: string, name: string, code: string) => {
	try {
...
const getExtractFunction = (extractFunctions: ((body: string, name: string, code: string) => string | null)[], body: string, name: string, code: string, postProcess: ((str: string) => void) | null = null): vmScript | null => {
...
const extractDecipher = (body: string, name: string, code: string) => {
...
const extractNTransform = (body: string, name: string, code: string) => {
...
export const extractFunctions = (body: string): [ReturnType<typeof extractDecipher>, ReturnType<typeof extractNTransform>] => {
	const { name, code } = extractTceFunc(body) as { name: string; code: string};
