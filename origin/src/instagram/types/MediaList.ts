...
export interface FanClubInfo2 {
    ...
    largest_public_bc_id: any
    subscriber_count?: number
    fan_consideration_page_revamp_eligiblity?: FanConsiderationPageRevampEligiblity2
}

export interface FanConsiderationPageRevampEligiblity2 {
    should_show_social_context: boolean
    should_show_content_preview: boolean
}
...
export interface MusicInfo2 {
    music_canonical_id: any
    music_asset_info: MusicAssetInfo2
    music_consumption_info: MusicConsumptionInfo2
}

export interface MusicAssetInfo2 {
    allows_saving: boolean
    artist_id?: string
    audio_asset_id: string
    audio_cluster_id: string
...
export interface MusicConsumptionInfo2 {
    allow_media_creation_with_music: boolean
    audio_asset_start_time_in_ms: number
    contains_lyrics: any
    derived_content_id: any
    ...
    audio_filter_infos: any[]
    audio_muting_info: AudioMutingInfo2
}
...
export interface AudioMutingInfo2 {
    mute_audio: boolean
    mute_reason_str: string
    allow_audio_editing: boolean
    show_muted_audio_toast: boolean
...
export interface ImageVersions22 {
    ...
    scrubber_spritesheet_info_candidates?: ScrubberSpritesheetInfoCandidates2
}
...
export interface ScrubberSpritesheetInfoCandidates2 {
    default: Default2
}
...
export interface VideoVersion2 {
    height: number
    id: string
    type: number
    url: string
