export interface Config {
    ...
    isCdnPocEnabled: boolean
    isArtistdpToTdpIngressEnabled: boolean
}
...
export interface Features {
    ...
    isRnAllAccessWebEnabled: boolean
    isRnRecapReelWebEnabled: boolean
    isProfileTransferWebEnabled: boolean
    isPCAEnabled: boolean
    isMaestroWebEnabled: boolean
}
